...
class BooleanDataTypesFilterTest extends QueryTest with BeforeAndAfterEach with BeforeAndAfterAll {
  ...
  override def beforeAll(): Unit = {
    ...
    val rootPath = new File(this.getClass.getResource("/").getPath
      + "../../../..").getCanonicalPath
    val storeLocation = s"$rootPath/integration/spark-common-test/src/test/resources/bool/supportBooleanOnlyBoolean.csv"
    ...
    val booleanLocation = s"$rootPath/integration/spark-common-test/src/test/resources/bool/supportBoolean.csv"
    sql(
      s"""
  ...
  test("Filtering table: support boolean and other data type, two boolean column") {
    ...
    val rootPath = new File(this.getClass.getResource("/").getPath
      + "../../../..").getCanonicalPath
    val booleanLocation2 = s"$rootPath/integration/spark-common-test/src/test/resources/bool/supportBooleanTwoBooleanColumns.csv"
    sql(
      s"""
