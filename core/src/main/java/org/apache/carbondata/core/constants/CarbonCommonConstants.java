...
import org.apache.carbondata.core.util.annotations.*;
...
public final class CarbonCommonConstants {
   ...
   */
  @DefaultValue
  public static final String BLOCKLET_SIZE_DEFAULT = "120000";

  /**
   * min blocklet size
   */
  @Threshold
  public static final int BLOCKLET_SIZE_MIN = 2000;

  /**
   * max blocklet size
   */
  @Threshold
  public static final int BLOCKLET_SIZE_MAX = 12000000;

  /**
   * default block size in MB
   */
  @DefaultValue
  public static final String BLOCK_SIZE_DEFAULT = "1024";
   ...
   */
  @Threshold
  public static final int BLOCK_SIZE_MAX = 2048;
   ...
   */
  @DefaultValue
  public static final String CARBON_BADRECORDS_LOC_DEFAULT = "";

  /**
   * Property for specifying the format of TIMESTAMP data type column.
   * e.g. yyyy/MM/dd HH:mm:ss, or using CARBON_TIMESTAMP_FORMAT_DEFAULT
   */
  @NonDynamicConfigurable
   ...
   */
  @DefaultValue
  public static final String CARBON_TIMESTAMP_FORMAT_DEFAULT = "yyyy-MM-dd HH:mm:ss";
   ...
   * e.g. yyyy/MM/dd , or using CARBON_DATE_FORMAT_DEFAULT
   */
  @NonDynamicConfigurable
  public static final String CARBON_DATE_FORMAT = "carbon.date.format";

  /**
   * CARBON_DATE_FORMAT_DEFAULT
   */
  @DefaultValue
  public static final String CARBON_DATE_FORMAT_DEFAULT = "yyyy-MM-dd";
   ...
   */
  @DefaultValue
  public static final String COMPRESSOR_DEFAULT = "snappy";
   ...
   */
  @DefaultValue
  public static final String ENABLE_CALCULATE_SIZE_DEFAULT = "true";
  /**
   ...
   */
  @DefaultValue
  public static final String FLAT_FOLDER_DEFAULT = "false";
   ...
   */
  public static final String NUM_CORES_DEFAULT = "2";
   ...
   */
  @DefaultValue
  public static final String CARBON_SORT_FILE_WRITE_BUFFER_SIZE_DEFAULT = "16384";
   ...
   */
  @DefaultValue
  public static final String CARBON_MERGE_SORT_READER_THREAD_DEFAULT = "3";
   ...
   */
  @DefaultValue
  public static final String ENABLE_AUTO_LOAD_MERGE_DEFAULT = "false";
   ...
   */
  @DefaultValue
  public static final String CARBON_MAJOR_COMPACTION_SIZE_DEFAULT = "1024";
   ...
   */
  @DefaultValue
  public static final String PRESERVE_LATEST_SEGMENTS_NUMBER_DEFAULT = "0";
   ...
   */
  @DefaultValue
  public static final String DAYS_ALLOWED_TO_COMPACT_DEFAULT = "0";
   ...
   */
  @DefaultValue
  public static final String SEGMENT_LEVEL_THRESHOLD_DEFAULT = "4,3";
   ...
   */
  @DefaultValue
  public static final String UPDATE_DELTAFILE_COUNT_THRESHOLD_IUD_COMPACTION_DEFAULT = "1";
   ...
   */
  @DefaultValue
  public static final String DELETE_DELTAFILE_COUNT_THRESHOLD_IUD_COMPACTION_DEFAULT = "1";
   ...
   */
  @DefaultValue
  public static final String ENABLE_CONCURRENT_COMPACTION_DEFAULT = "true";
   ...
   */
  public static final String SORT_SIZE_DEFAULT = "100000";

  /**
   * min carbon sort size
   */
  public static final int SORT_SIZE_MIN = 1000;
   ...
   */
  @DefaultValue
  public static final int MAX_QUERY_EXECUTION_TIME_DEFAULT = 60;
   ...
   */
  @DefaultValue
  public static final String CARBON_QUERY_MIN_MAX_ENABLED_DEFAULT = "true";
   ...
   */
  @DefaultValue
  public static final String ENABLE_UNSAFE_IN_QUERY_EXECUTION_DEFAULT = "false";
  ...
  @DefaultValue
  public static final String SUPPORT_DIRECT_QUERY_ON_DATAMAP_DEFAULT = "false";
  ...
  @DefaultValue
  public static final String VALIDATE_DIRECT_QUERY_ON_DATAMAP_DEFAULT = "true";
  ...
  /**
   * DIMENSION_SPLIT_VALUE_IN_COLUMNAR_DEFAULT
   */
  public static final String DIMENSION_SPLIT_VALUE_IN_COLUMNAR_DEFAULT = "1";

  /**
   * IS_FULLY_FILLED_BITS_DEFAULT
   */
  public static final String IS_FULLY_FILLED_BITS_DEFAULT = "true";
  ...
  /**
   * TEMP_WRITE_FILE_EXTENSION
   */
  public static final String TEMP_WRITE_FILE_EXTENSION = ".write";
