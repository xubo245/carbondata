...
public final class CarbonLoadOptionConstants {
   ...
   */
  @DynamicConfigurable
  public static final String CARBON_OPTIONS_DATE_FORMAT =
   ...
   */
  @DynamicConfigurable
  public static final String CARBON_OPTIONS_TIMESTAMP_FORMAT =
          "carbon.options.timestamp.format";

  @DefaultValue
  public static final String CARBON_OPTIONS_TIMESTAMP_FORMAT_DEFAULT = "";
